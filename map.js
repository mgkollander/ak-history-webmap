...
const loadGeoJSON = (map) => {
    ...
    leafletView.PrepareLeafletMarker = function(leafletMarker, data) {
        var endDate = data.properties.endDate;
        var popupContent = "<b>" + data.properties.description + "</b><br>End Date: " + endDate;
        const customIcon = L.icon({
            iconUrl: 'data/icons/pin.png',
            iconSize: [50, 50],
            iconAnchor: [3, 30],
    ...
    var pruneClusterLayer = L.layerGroup();
